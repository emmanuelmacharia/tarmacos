...
export function internalServerError(message = 'Internal Server Error', details: unknown = {}): never {
    mapConvexError({
        status: 500,
        message,
        details,
...
export function assertFound<T>(value: T | null | undefined, message = 'Not Found', details: unknown = {}): T {
