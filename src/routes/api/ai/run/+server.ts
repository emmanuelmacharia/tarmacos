...
import { WorkflowRequestSchema, type WorkflowEvent } from '$lib/server/ai/schemas';
// import { runWriterReviewerWorkflow } from '$lib/server/ai/workflow';
...
export const POST: RequestHandler = async ({ request }) => {
	...
	// console.log('Received workflow request:', parsed);
